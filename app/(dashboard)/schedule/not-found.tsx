  ...
  return (
    <main className="flex-1 p-4 md:p-8">
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
        ...
        <p className="text-on-surface font-headline-md">Schedule not found</p>
        <p className="text-on-surface-variant text-body-md">The schedule page is currently unavailable.</p>
        <Link
          href="/"
